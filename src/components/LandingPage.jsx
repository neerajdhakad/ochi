    ...
    <div className="w-full h-screen bg-zinc-900 pt-2">
        ...
        <div className="border-t-[1px] border-zinc-700 mt-20 flex flex-col md:flex-row md:items-center justify-between">
            {["For public and private companies","From the first pitch to IPO"].map((item,index)=>{
                return <p key={index} className="py-5 px-10 md:px-20 text-md tracking-tight leading-none">{item}</p>
            })}
        <div className="start flex items-center gap-2 px-10 md:px-20">
            <div className="px-3 md:px-5 py-2 border-[1px] border-zinc-400 font-light text-sm md:text-md uppercase rounded-full">start the project</div>
