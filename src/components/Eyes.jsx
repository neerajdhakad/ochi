  ...
  return (
    <div className="eyes w-full h-screen overflow-hidden">
      <div data-scroll data-scroll-speed="-.7" className="flex items-center justify-center w-full h-full bg-cover bg-center bg-[url('https://ochi.design/wp-content/uploads/2022/05/Top-Viewbbcbv-1-scaled.jpg')]">
        ...
        <div className="flex items-center justify-center gap-4 md:gap-10 md:px-8 h-44 md:h-64">
          <div className="flex items-center justify-center w-[25vw] h-[25vw] md:w-[15vw] md:h-[15vw]  bg-white rounded-full">
            <div className="relative bg-black w-2/3 h-2/3 text-2xl rounded-full ">
                <div style={{transform:`translate(-50%,-50%) rotate(${rotate}deg)`}} className="absolute top-1/2 left-1/2 -translate-x-[50%] -translate-y-[50%] line w-full h-10">
                    <div className="bg-white w-6 h-6 md:w-10 md:h-10 rounded-full"></div>
                </div>
            </div>
          </div>
          <div className="flex items-center justify-center w-[25vw] h-[25vw] md:w-[15vw] md:h-[15vw]  bg-white rounded-full">
            <div className="relative bg-black w-2/3 h-2/3 text-2xl rounded-full text-white ">
                <div style={{transform:`translate(-50%,-50%) rotate(${rotate}deg)`}} className="absolute top-1/2 left-1/2 -translate-x-[50%] -translate-y-[50%] line w-full h-10">
                    <div className="bg-white w-6 h-6 md:w-10 md:h-10 rounded-full"></div>
                </div>
            </div>
