function Footer() {
  return (
    <>
      <div className="flex gap-5 w-full h-full flex-col md:flex-row md:h-screen p-10 md:p-20 bg-[#f1f1f1] text-black  rounded-t-xl mt-10 md:mt-50">
        <div className="w-1/2 h-full flex flex-col justify-between ">
          <div className="heading">
            <h1 className="text-4xl md:text-7xl font-bold uppercase leading-none tracking-tight">
              EYE-
            </h1>
            <h1 className="text-4xl md:text-7xl font-bold uppercase leading-none tracking-tight">
              opening
        ...
        <div className="w-1/2">
          <h1 className="text-4xl md:text-7xl font-bold uppercase leading-3 tracking-tight">
            presentations
          </h1>

          <div className="dets font-['Neue_Montreal'] py-10">
            <h1 className="pb-5">S:</h1>
            <a className="block text-sm md:text-lg underline" href="#">
              Facebook
            </a>
            <a className="block text-sm md:text-lg underline" href="#">
              Instagram
          ...
          {/* M & L Start*/}
          <div className="flex gap-14 justify-between second-part">

            <div className="dets font-['Neue_Montreal'] py-5">
              <h1 className="pb-5">M:</h1>
              <a className="block text-sm md:text-lg underline" href="#">
                Home
              </a>
              <a className="block text-sm md:text-lg underline" href="#">
      ...
      <div className="footer-end w-full flex flex-col md:justify-center md:items-center gap-4 md:flex-row p-10 md:p-15 bg-[#f1f1f1] text-black">

        <div className="w-full md:w-1/2 flex flex-col  md:flex-row md:justify-center gap-10 md:items-center">
          <div className="">
            <svg
              width="72"
              height="30"
          ...
          <div className="w-full md:mt-0">
            <p className="text-md md:text-lg text-slate-300">
              &copy; ochi designs {new Date().getFullYear()}{" "}
        ...
        <div className="w-full md:w-1/2">
          <p className="text-md md:text-lg text-slate-300">Website by Neeraj</p>
        </div>
      </div>
    </>
  );
