function Footer() {
  return (
    <div className="flex gap-5 w-full h-full flex-col md:flex-row md:h-screen p-10 md:p-20 bg-[#f1f1f1] text-black overflow-hidden">
      <div className="w-1/2 h-full flex flex-col justify-between ">
        <div className="heading">
          <h1 className="md:text-8xl font-bold uppercase leading-none">EYE-</h1>
          <h1 className="md:text-8xl font-bold uppercase leading-none">
            opening
          </h1>
        </div>
        <svg
      ...
      <div className="w-1/2">
        <h1 className="md:text-8xl font-bold uppercase leading-3">
          presentations
        </h1>
...
{
  /* <div className="w-full py-10 md:py-20 md:w-1/2 a">
<h1 className="text-5xl md:text-9xl font-bold leading-none tracking-tight uppercase">EYE- <br />opening</h1>
</div>
<div className="w-full py-10 md:py-20 md:w-1/2 a">
<h1 className="text-5xl md:text-9xl font-bold leading-none tracking-tighter uppercase">presentations</h1>
</div> */
}
